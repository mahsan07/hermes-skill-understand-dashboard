---
name: hermes-skill-understand-dashboard
description: Launch an interactive dashboard that visualizes a codebase knowledge graph. Use when the user explicitly requests this capability or a closely related task.
---
